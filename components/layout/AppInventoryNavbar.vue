...
async function getAccount() {
  account.value = JSON.parse(localStorage.getItem('userData'))
}
              ...
              >
                <div class="flex">
                  ...
                  <div class="my-auto w-[100px] mx-2">
                    <strong class="mb-0.5 line-clamp-1 text-sm">{{ account?.nama_lengkap }}</strong>
                    <div class="text-xs text-diventory-black-secondary capitalize">
                      {{ account.jabatan }}
                    </div>
                  </div>
                  <svg
