...
const modalEditGoods = ref(false)
...
function showEditGood(row) {
  selectedGood.value = row
  modalEditGoods.value = !modalEditGoods.value
}

function showModalDeleteGood(row) {
  selectedGood.value = row
...
<template>
    ...
    <UTable :rows="filteredRows" :columns="columns">
      ...
      <template #action-data="{ row }">
        <div class="flex gap-3">
          ...
          <div class="cursor-pointer" @click="showEditGood(row)">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="cursor-pointer" @click="showModalDeleteGood(row)">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <ManageGoodsModalEditGoods :show="modalEditGoods" :selected-good="selectedGood" @close="modalEditGoods = false" @refresh="refresh" />
