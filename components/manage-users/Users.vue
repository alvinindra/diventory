...
const modalDetailUser = ref(false)
const modalAddUsers = ref(false)
const modalEditUsers = ref(false)
...
function showEditUser(row) {
  selectedUser.value = row
  modalEditUsers.value = !modalEditUsers.value
}
...
<template>
    ...
    <UTable :rows="filteredRows" :columns="columns">
      ...
      <template #action-data="{ row }">
        <div class="flex gap-3">
          <div class="cursor-pointer" @click="showDetailUser(row)">
          ...
          <div class="cursor-pointer" @click="showEditUser(row)">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <LazyManageUsersModalDetailUser :show="modalDetailUser" :user="selectedUser" @close="modalDetailUser = false" />
  <LazyManageUsersModalAddUsers :show="modalAddUsers" @refresh="refresh" @close="modalAddUsers = false" />
  <BaseModalDelete :show="showModalDelete" @close="showModalDelete = false" @delete="deleteUser" />
  <LazyManageUsersModalEditUsers :show="modalEditUsers" :user="selectedUser" @refresh="refresh" @close="modalEditUsers = false" />
</template>
